...
public class GenericUnitOfWork<T> : IGenericUnitOfWork<T> where T : class
{
    ...
    public virtual async Task<ActionResponse<IEnumerable<T>>> GetAsync(PaginationDTO paginationDTO) => await _repository.GetAsync(paginationDTO);

    public virtual async Task<ActionResponse<int>> GetTotatlRecordsAsync() => await _repository.GetTotatlRecordsAsync();
